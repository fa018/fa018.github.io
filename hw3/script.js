...
let x1 = 0, y1 = 0, dx1 = 5, dy1 = 5, r1 = 30, color1 = "red", m1 = 30;
let x2 = canvas.width, y2 = 0, dx2 = -5, dy2 = 5, r2 = 30, color2 = "blue", m2 = 5;
...
function draw()
{
    ...
    {
        let M = m1+m2;
        [[dx1, dy1], [dx2, dy2]] = [[((m1-m2)*dx1+2*m2*dx2)/M, ((m1-m2)*dy1+2*m2*dy2)/M], [((m2-m1)*dx2+2*m1*dx1)/M, ((m2-m1)*dy2+2*m1*dy1)/M]]
    }
